...
export default function ProyectoPage() {
  ...
  const proyecto = {
    titulo: "Proyecto Deportivo Integral",
    descripcion:
      "Nuestro Proyecto Deportivo Integral utiliza el poder del deporte como herramienta de desarrollo personal y social. Ofrecemos programas deportivos estructurados, entrenamiento de habilidades para la vida y oportunidades de liderazgo para jóvenes en riesgo, promoviendo la salud física y mental, la disciplina y la cohesión comunitaria.",
    imagenUrl: "/fondis13.jpg",
    categorias: ["Deporte", "Desarrollo Juvenil", "Salud y Bienestar"],
    anioInicio: 2021,
    impacto:
      "Hemos involucrado a más de 2,000 jóvenes en actividades deportivas regulares, reduciendo las tasas de delincuencia juvenil en un 30% en las áreas del proyecto y mejorando el rendimiento académico en un 40% entre los participantes.",
    duracion: "2021-Presente",
    ubicacion: "Instalaciones deportivas comunitarias en zonas urbanas de alta vulnerabilidad",
  }
